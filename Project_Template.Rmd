...
ggplot(Stanislaus_Air_Data_Processed, aes(x = as.numeric(month), y = avg_PM25, color = year, group = year)) +
  geom_line() +
  ...
  theme_minimal() +
  theme(
    axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1),  #Angle labels for better readability
